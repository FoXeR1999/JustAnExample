 ...
 */
var walkingChallenges: [String] = ["Walk 2 miles", "Walk up 4 flights of stairs"]
var runningChallenges: [String] = ["Run 8 miles", "Do a power run"]
/*:
...
let walkingArray = challenges[0]
let walkingArrayFirstElement = challenges[0][0]
let runningArray = challenges[1]
let runningArrayFirstElement = challenges[1][0]
 ...
 */
var challengesDone: [String] = []

/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if challengesDone.isEmpty {
    print("Complete a challenge!")
} else if challengesDone.count == 1 {
    print("The challenge you have chosen is <INSERT CHOSEN CHALLENGE>")
} else {
