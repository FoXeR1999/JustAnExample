 ...
 */
func introduceMyself(firstName: String, hobbies: String) {
    
    print("Your name is \(firstName) and your hobbies are \(hobbies)")
    
}

introduceMyself(firstName: "Justin", hobbies: "Ping-pong")
/*:
