...
struct User {
    ...
    static var currentUser: User = User(userName: "J-ZAWG", email: "justinzog@gmail.com", age: 17)
    
    static func logIn(currentLoggedInUser: User) {
        currentUser = currentLoggedInUser
        print("\(currentUser.userName) has joined the party")
    }
}
 ...
 */
let Suzashi = User(userName: "Suzashi", email: "justinzog@gmail.com", age: 17)
User.logIn(currentLoggedInUser: Suzashi)
...
//}
//
//let justinCake = Cake(color: "Yellow", flavor: "Vanilla")
//
//var color = justinCake.color
//
//print(color)
