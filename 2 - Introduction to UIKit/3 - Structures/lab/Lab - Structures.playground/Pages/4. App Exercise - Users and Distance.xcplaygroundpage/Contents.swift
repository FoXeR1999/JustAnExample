 ...
 */
var Justin = User(name: "Justin", age: 17, height: 74, weight: 145, activityLevel: 9)
...
struct Distance {
    ...
    init(meters: Double) {
        ...
        self.yards = (meters / 0.9144)
        self.meters = meters
        
    }
    init(feet: Double) {
        self.meters = (feet * 3.28084)
        self.yards = (feet * 3.333333)
        self.feet = feet
 ...
 */
var fiveK = Distance(meters: 5000)
