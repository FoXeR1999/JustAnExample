...
class Fighter: Spaceship {
    ...
    init(weapon: String, remaingFirePower: Int) {
        self.weapon = ""
 ...
 */
var destroyer = Fighter(weapon: "Laser", remaingFirePower: 10)
 ...
 */
// print(falcon.weapon)
// This will pull up an error because "falcon" is not in the subclass Destroyer, it is only in the superclass of Spaceship
