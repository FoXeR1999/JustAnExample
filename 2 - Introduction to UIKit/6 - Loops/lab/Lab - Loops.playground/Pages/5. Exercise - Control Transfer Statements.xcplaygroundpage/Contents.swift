 ...
 */
var statesAndCapitals = ["Idaho": "Boise", "Colorado": "Denver", "Utah": "Salt Lake"]

for key in statesAndCapitals.keys {
    print(statesAndCapitals[key])
    if statesAndCapitals[key] == "Salt Lake" {
