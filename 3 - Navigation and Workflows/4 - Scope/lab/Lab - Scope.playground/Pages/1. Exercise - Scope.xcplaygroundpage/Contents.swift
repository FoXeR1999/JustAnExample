...
// Because foo only exists in the for _ in loop.
/*:
...
// Because var x exist both in and out of the for _ in statement.
/*:
...
greeting(greeting: "Moshi moshi", name: "Ballred")

greeting(greeting: nil, name: "Ballred")
/*:
