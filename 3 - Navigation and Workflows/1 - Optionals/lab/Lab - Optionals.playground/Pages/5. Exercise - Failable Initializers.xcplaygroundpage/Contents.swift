 ...
 */
let badComputer = Computer(ram: 0, yearManufactured: 1968)

if let tempComputer = badComputer {
    print(tempComputer.ram)
    print(tempComputer.yearManufactured)
}

let goodComputer = Computer(ram: 16, yearManufactured: 2016)

if let tempComputer = goodComputer {
    print(tempComputer.ram)
    print(tempComputer.yearManufactured)
}
