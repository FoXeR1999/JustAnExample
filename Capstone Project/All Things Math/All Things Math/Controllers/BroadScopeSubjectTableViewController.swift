...
class BroadScopeSubjectTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let subjectDictionary = (subjectsStruct.subjects.keys).sorted() // Alphabatized subjects
        
        cell.textLabel?.text = subjectDictionary[indexPath.row]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let indexPath = tableView.indexPathForSelectedRow,
            ...
            // get the info for the narrowScopeTVC
        }
