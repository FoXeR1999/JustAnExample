 ...
 */
var namesArray: [String] = ["Ballred", "Lukey G", "Toast", "Heavy D", "Tyson", "Crowlther"]

let sortedNamesArray1 = namesArray.sorted { $0 < $1 }

print(sortedNamesArray1)
 ...
 */
// I think I accidentally already did that above
// Here's what I was suppose to do above

let sortedNamesArray2 = namesArray.sorted(by: forwards)
print(sortedNamesArray2)
 ...
 */
// I also did this on the first one hahahahahahaha
